...
pipeline_config_path=/tinysrc/data/$config
...
cp /tinysrc/data/ssd_mobilenet_v1_pets.config /output
...
python /tinysrc/models/research/object_detection/eval.py --checkpoint_dir=/data/dansun888/ssd-mobilenet-detection --eval_dir=/tinysrc/eval_dir --pipeline_config_path=$pipeline_config_path
