...
echo "############ export #################"
# 导出模型
python /tinysrc/models/research/object_detection/export_inference_graph.py --input_type image_tensor --pipeline_config_path $pipeline_config_path --trained_checkpoint_prefix $train_dir/model.ckpt-10  --output_directory $output_dir/exported_graphs
echo "############ test #################"
# 在test.jpg上验证导出的模型
python /tinysrc/models/research/inference.py --output_dir=$output_dir/exported_graphs --dataset_dir=$dataset_dir
